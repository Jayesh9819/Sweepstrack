<?php include "./App/helper/link.php";

// Start the session if not already started
if (session_status() !== PHP_SESSION_ACTIVE) session_start();

// Get the previous URL from the session's visited_urls array
$previousUrl = '#'; // Default fallback if no previous URL is found
if (isset($_SESSION['visited_urls']) && count($_SESSION['visited_urls']) > 1) {
   $urlCount = count($_SESSION['visited_urls']);
   $previousUrl = $_SESSION['visited_urls'][$urlCount - 2]; // Second last item in the array
}
   ...
   <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
      <div class="container-fluid navbar-inner">
		...
		c-1.407,1.406-2.197,3.313-2.197,5.303c0.001,1.99,0.791,3.896,2.198,5.305L94.861,156.507z" />
                           ...
                           </svg> <span class="nav-text ms-2">Back</span>
                        </a>

                     </li>
                     <li class="nav-item ">
                        <a class="nav-link menu-arrow justify-content-start active" data-bs-toggle="colapse" href="./Portal" role="button" target="" aria-expanded="false" aria-controls="homeData">
         ...
         <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 " style="display: flex; flex-direction: row;">
            ...
            <li class="nav-item dropdown">
               <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <img src="../uploads/profile/<?= !empty($_SESSION['p_p']) ? $_SESSION['p_p'] : '07.png' ?>" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                  ...
                  <img src="../assets/images/avatars/avtar_4.png" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                  <img src="../assets/images/avatars/avtar_5.png" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                  <div class="caption ms-3 d-none d-md-block ">
                     <h6 class="mb-0 caption-title"><?php echo  $_SESSION["fullname"];  ?></h6>
                     <p class="mb-0 caption-sub-title"><?php echo  $_SESSION["role"];  ?></p>
                  </div>
               </a>
               <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                  ...
                  <form action="../Public/Pages/Common/destroy_session.php" method="post">
                     <li><button type="submit" class="dropdown-item" href="auth/sign-in.html">Logout</button></li>
                  </form>
               </ul>
            </li>
         </ul>
