                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a name="" id="" class="btn btn-primary" href="./Chat_Screen?user=<?= $profile['username'] ?>" role="button">Message</a>
                                    <a name="" id="" class="btn btn-primary" href="./deposit?u=<?= $profile['username'] ?>" role="button">Recharege</a>
                                    <a name="" id="" class="btn btn-primary" href="./cash_out?u=<?= $profile['username'] ?>" role="button">Reedem</a>
