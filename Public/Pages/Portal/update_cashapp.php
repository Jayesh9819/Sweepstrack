                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0);" class="btn btn-outline-info rounded-pill mt-2" onclick="delete1(<?php echo $id; ?>, 'cashapp','cid')">
                                ...
                                try {
                                    ...
                                    if (response) {
                                        ...
                                        if (response.success) {
                                            ...
                                            window.location.href = "./Portal_Cashup_Management";
                                        } else {
